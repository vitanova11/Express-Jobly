...
afterAll(commonAfterAll);//Jest, the afterEach and afterAll functions are recognized as special lifecycle hooks. The framework understands their purpose and executes them at the appropriate times:

// afterEach is executed after each test (test or it block) within a describe block.
